...
public interface ClickEventRepository extends JpaRepository<ClickEvent, Long> {
    ...
    List<ClickEvent> findByUrlMappingAndClickDateBetween(@Param("urlMappings") List<UrlMapping> urlMappings, @Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
